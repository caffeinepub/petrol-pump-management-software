...
const sections = [
  {
    icon: Settings,
    title: 'Settings',
    description: 'Configure application preferences, display options, and regional settings.',
  },
  {
    icon: Bell,
    title: 'Notifications',
    description: 'Manage alert preferences for low stock, pending invoices, and staff updates.',
  },
  {
    icon: Shield,
    title: 'Security',
    description: 'Review access control, manage user roles, and audit login activity.',
  },
  {
    icon: HelpCircle,
    title: 'Help & Support',
    description: 'Browse documentation, FAQs, and contact support for assistance.',
  },
  {
    icon: Info,
    title: 'About',
    description: 'View application version, license information, and release notes.',
  },
];
