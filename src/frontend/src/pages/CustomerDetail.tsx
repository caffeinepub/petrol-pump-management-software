...
import { ArrowLeft, Car, Mail, Phone, ShoppingBag, Star } from "lucide-react";
...
export default function CustomerDetail() {
  ...
  const totalLitres = customerSales.reduce(
          ...
          <CardContent className="space-y-3">
            ...
            <div className="pt-2 border-t border-border">
              <p className="text-xs text-muted-foreground">
                Member since {customer.registrationDate}
              </p>
            </div>
          </CardContent>
        </Card>
              ...
              {customerSales.map((sale) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {sale.date} · {sale.litres ?? sale.quantity}L · Pump{" "}
                      {sale.pumpNumber}
                    </p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-bold text-foreground">
                      {formatINR(sale.total ?? sale.totalAmount ?? 0)}
                    </p>
